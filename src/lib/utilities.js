...
function getUserFromToken(authorization) {
    return new Promise((resolve, reject) => {
        if (authorization) {
            ...
            try {
                jwt.verify(token, SECRET_KEY, (err, payload) => __awaiter(this, void 0, void 0, function* () {
                    let userLogged = yield new user_service_1.default().getUserByEmail(payload === null || payload === void 0 ? void 0 : payload.email);
                    resolve(userLogged);
                }));
            }
            catch (err) {
